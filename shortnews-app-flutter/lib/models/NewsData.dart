...
class NewsData {
  ...
  String? categoryName; // Added By SMARTINTEL
  DocumentReference? authorRef;
  List<String>? caseSearch;
  // BannerAdModel? bannerAd;
  bool? bannerAd;
  ...
  Map<String, dynamic> toJson({bool toStore = true}) {
    ...
    data[NewsKeys.categoryName] = this.categoryName;
  ...
  setCategoryName() async {
    CategoryData data = await newsService.getNewsCategory(categoryRef!);
